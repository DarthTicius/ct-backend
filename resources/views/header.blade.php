...
<div class="backdop_menu relative z-40 lg:hidden" role="dialog" aria-modal="true">
  ...
  To: "opacity-0"
 -->
    <div class="fixed hidden inset-0 bg-black bg-opacity-25"></div>

    <div class="fixed hidden inset-0 z-40 flex">
        <!--
            ...
            <div class="mt-2">
                ...
                <div id="tabs-1-panel-1" class="space-y-10 px-4 pt-10 pb-8" aria-labelledby="tabs-1-tab-1"
                    ...
                    <div class="space-y-10">
                        <div>
                            <p id="women-shoes-heading-mobile" class="font-medium text-gray-900">Shoes &amp; Accessories
                            </p>
                        ...
                        <div>
                            <p id="women-collection-heading-mobile" class="font-medium text-gray-900">Shop Collection
                            </p>
                            <ul role="list" aria-labelledby="women-collection-heading-mobile"
                                class="mt-6 flex flex-col space-y-6">
                                <li class="flow-root">
                    ...
                    <div class="space-y-10">
                        ...
                        <div>
                            <p id="women-accessories-heading-mobile" class="font-medium text-gray-900">All Accessories
                            </p>
                ...
                <div id="tabs-1-panel-2" class="space-y-10 px-4 pt-10 pb-8" aria-labelledby="tabs-1-tab-2"
                    ...
                    <div class="space-y-10">
                        <div>
                            <p id="men-shoes-heading-mobile" class="font-medium text-gray-900">Shoes &amp; Accessories
                            </p>
                            <ul role="list" aria-labelledby="men-shoes-heading-mobile"
                                class="mt-6 flex flex-col space-y-6">
                                <li class="flow-root">
                                    <a href="#" class="-m-2 block p-2 text-gray-500">Sneakers</a>
                                </li>
                        ...
                        <div>
                            <p id="men-collection-heading-mobile" class="font-medium text-gray-900">Shop Collection
                            </p>
                            <ul role="list" aria-labelledby="men-collection-heading-mobile"
                                class="mt-6 flex flex-col space-y-6">
                                <li class="flow-root">
                                    <a href="#" class="-m-2 block p-2 text-gray-500">Everything</a>
                                </li>
                    ...
                    <div class="space-y-10">
                        ...
                        <div>
                            <p id="men-accessories-heading-mobile" class="font-medium text-gray-900">All Accessories
                            </p>
...
<header class="relative bg-white">
    <nav aria-label="Top" class="mx-auto max-w-1.5xl px-4 sm:px-6 lg:px-0">
     ...
     Leaving: "transition ease-in duration-150"
      ...
      To: "opacity-0"
     -->
                            <div class="hidden absolute inset-x-0 top-full z-10 text-sm text-gray-500">
